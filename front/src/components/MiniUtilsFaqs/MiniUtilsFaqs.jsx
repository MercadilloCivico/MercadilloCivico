...
const MiniUtilsFaqs = () => {
  ...
  return (
    <div className='mx-2 lg:hidden'>
      <span className='flex justify-start text-start text-[1em] md:text-[1.5em] text-tuscany-950 font-bold'>
      ...
      {top5FaqsByLikes?.map((faq) => (
        <Link
          ...
          className='my-4 flex flex-row items-center justify-start p-3 text-tuscany-500 cursor-pointer text-[.7em] font-semibold text-start hover:text-tuscany-950 custom-border-y'>
          <MdKeyboardDoubleArrowRight className='text-[2em]' />
