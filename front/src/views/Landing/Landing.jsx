...
function Home() {
  return (
    <div className={style.landingAnim}>
      ...
      <p className='text-pearl-bush-950 m-auto my-5 mb-10 max-w-[600px] p-1 text-xl px-4'>
      ...
      <div>
        <p className='text-pearl-bush-950 m-auto my-5 max-w-[600px] p-1 mt-[150px] text-xl px-4'>
      ...
      <div
        ...
        <p className='text-pearl-bush-950 text-center m-[20px] max-w-[600px] p-1  px-4'>
      ...
      <div>
        <p className='text-pearl-bush-950 m-auto my-5 max-w-[600px] p-1 text-xl px-4'>
